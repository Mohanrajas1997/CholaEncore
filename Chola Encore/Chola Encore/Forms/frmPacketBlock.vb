Public Class frmPacketBlock
    ...
    Private Sub ListAll(ByVal PacketBlockId As Long)
        ...
        msSql = ""
        msSql &= " select a.*,b.packet_gnsarefno,c.shortagreement_no,c.agreement_no from chola_trn_tpacketblock as a "
    ...
    Private Sub btnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFind.Click
        ...
        Try
            SearchDialog = New Search(gOdbcConn, _
                             " select a.packetblock_gid as 'Block Id',a.packetblock_sno as 'Block SNo',b.packet_gnsarefno as 'Packet No'," & _
                             ...
                             " a.packetblock_gid,a.packetblock_sno,b.packet_gnsarefno,c.shortagreement_no,c.agreement_no,a.packetblock_reason,a.packetblock_entryon,a.packetblock_entryby", _
