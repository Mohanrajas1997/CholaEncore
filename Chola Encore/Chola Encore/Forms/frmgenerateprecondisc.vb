Public Class frmgenerateprecondisc
    Dim lssql As String
        ...
        For i = 0 To objdt.Rows.Count - 1
            ...
            If lnAgreementId > 0 Then
                ...
                Select Case dtentry.Rows.Count
                    Case 1
                        If Val(objdt.Rows(i).Item("finone_chqno").ToString) <> Val(dtentry.Rows(0).Item("chq_no").ToString) Then
                    ...
                    Case Else
                        ...
                        lssql &= " and chq_no = " & Val(objdt.Rows(i).Item("finone_chqno").ToString) & " "
                        dtentry = GetDataTable(lssql)
    ...
    Private Sub PostGNSAVSFinone(ByVal CycleDate As Date)
        ...
        For i = 0 To objdt.Rows.Count - 1
            ...
            If lnAgreementid <> "" Then
                ...
                Select Case dtentry.Rows.Count
                    ...
                    Case Else
                        ...
                        lssql &= " and finone_chqno = " & Val(objdt.Rows(i).Item("chq_no").ToString) & " "
                        dtentry = GetDataTable(lssql)
                        ...
                        Select Case dtentry.Rows.Count
                            ...
                            Case Else
                                ...
                                Select Case dtentry.Rows.Count
                                    Case 1
                                        If Val(objdt.Rows(i).Item("chq_no").ToString) <> Val(dtentry.Rows(0).Item("finone_chqno").ToString) Then
                                            lnDisc = lnDisc Or GCDISCCHQNO
                                        End If
            ...
            lssql &= " set chq_predisc=((chq_predisc |chq_predisc)^ chq_predisc ) | " & lnDisc
