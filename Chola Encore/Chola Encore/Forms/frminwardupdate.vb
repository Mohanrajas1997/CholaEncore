    ...
    Private Sub Importexcel(ByVal FilePath As String, ByVal SheetName As String)
        ...
        Try
            ...
            For liIndex As Integer = 0 To lExcelDatatable.Rows.Count - 1
                ...
                lnInwardId = Val(gfExecuteScalar(lssql, gOdbcConn))

                'Write Dulicate Record in Error log
                If lnInwardId = 0 Then
                    lidup += 1
                    liIsDuplicate += 1
                    lsDuplicatedtl = Now() & "  Record Not Found.. " & QuoteFilter(lExcelDatatable.Rows(liIndex)("AGREEMENTNO").ToString)
                    PrintLine(1, lsDuplicatedtl)
                    GoTo GoNext
                End If
                ...
                Try
                    ...
                    lssql &= " inward_pdc = " & Val(QuoteFilter(lExcelDatatable.Rows(liIndex).Item("Pdc").ToString.Trim)) & ","
                    lssql &= " inward_spdc = " & Val(QuoteFilter(lExcelDatatable.Rows(liIndex).Item("Spdc").ToString.Trim)) & " "
