...
Public Class frmAuthrejectreason
    ...
    Private Sub frmAuthrejectreason_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Enter Then SendKeys.Send("{TAB}")
    End Sub

    Private Sub frmAuthrejectreason_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        e.KeyChar = e.KeyChar.ToString.ToUpper
    End Sub

    Private Sub frmAuthrejectreason_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        EnableSave(False)
        btnNew.Focus()
    End Sub
    ...
    Private Sub btnFind_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFind.Click
        ...
        Try
            SearchDialog = New Search(gOdbcConn, _
                               ...
                               " from chola_mst_trejectreason ", _
            ...
            If Val(txt) <> 0 Then
                Call ListAll("select * from chola_mst_trejectreason" _
        ...
        Try
            ...
            Else
                ...
                If MsgBox("Are you sure to delete this record?", MsgBoxStyle.YesNo + MsgBoxStyle.Question, gProjectName) = MsgBoxResult.Yes Then
                    ...
                    fsSql = " update chola_mst_trejectreason set reason_deleteflag = 'Y' "
                    ...
                    EnableSave(False)
                    'Else
                    '    MsgBox("Select Reason Mapped With Reject list.. You can't delete..", MsgBoxStyle.Information, gProjectName)
                    'End If
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            If txtid.Text = "" Then
                fsSql = " insert into chola_mst_trejectreason(reason_name,reason_insertdate,reason_insertby)"
                fsSql &= " values('" & QuoteFilter(txtreasonname.Text.Trim) & "',"
                fsSql &= "sysdate(),'" & gUserName & "')"
            Else
                fsSql = " update chola_mst_trejectreason set"
    ...
    Function ChkDuplicate() As Boolean
        Dim lnGid As Long = 0
        fsSql = " select reason_gid from chola_mst_trejectreason"
