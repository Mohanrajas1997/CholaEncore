...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'pnlExport
        '
        Me.pnlExport.Controls.Add(Me.pnlButton)
        ...
        'pnlButton
        '
        Me.pnlButton.Controls.Add(Me.btnNotepad)
        Me.pnlButton.Controls.Add(Me.btnExport)
        Me.pnlButton.Location = New System.Drawing.Point(367, 5)
        Me.pnlButton.Name = "pnlButton"
        Me.pnlButton.Size = New System.Drawing.Size(153, 27)
        Me.pnlButton.TabIndex = 15
        '
        'btnNotepad
        '
        Me.btnNotepad.Location = New System.Drawing.Point(78, 0)
        Me.btnNotepad.Name = "btnNotepad"
        Me.btnNotepad.Size = New System.Drawing.Size(72, 24)
...
#End Region
    ...
    Private Sub LoadData()
        ...
        'Dim gOdbcConnQry As New Odbc.OdbcConnection
        ...
        Try
            ...
            '    lsCnStr = "Driver={Mysql odbc 3.51 Driver};Server=" & DbIP & ";DataBase=" & Db & ";uid=query;pwd=query;port=" & DbPort

            '    gOdbcConnQry.ConnectionString = lsCnStr
            '    gOdbcConnQry.Open()
    ...
    Private Sub frmLoanReport_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Resize
        ...
        pnlButton.Left = Math.Abs(pnlExport.Width - pnlButton.Width)
    End Sub
    ...
    Private Sub frmQryReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim lsSql As String
        lsSql = " select * from chola_mst_tqry where delete_flag='N' order by qry_code"
    ...
    Private Sub btnNotepad_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNotepad.Click
        Try
            PrintDGridToNotepad(dgvReport, gsReportPath & "\Report.txt")
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
