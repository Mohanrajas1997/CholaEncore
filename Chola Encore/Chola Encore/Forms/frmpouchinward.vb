Public Class frmpouchinward
        ...
        With ds.Tables("Inward")
            Select Case .Rows.Count
                Case 1
                    ...
                    'Log Packet
                    LogPacketHistory(txtgnsarefno.Text.Trim, GCINWARDENTRY, lnPacketGid)
    ...
    Private Sub cboAgreementNo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboAgreementNo.GotFocus
        ...
        If txtShortAgreementNo.Text <> "" Then
            lsSql = ""
            lsSql &= " select distinct concat(inward_agreementno,'-',inward_customername) as inward_agreementno from chola_trn_tinward "
            lsSql &= " where inward_shortagreementno = '" & txtShortAgreementNo.Text & "' "
            lsSql &= " and inward_packet_gid = 0 "
            lsSql &= " order by inward_gid desc "

            Call gpBindCombo(lsSql, "inward_agreementno", "inward_agreementno", cboAgreementNo, gOdbcConn)
