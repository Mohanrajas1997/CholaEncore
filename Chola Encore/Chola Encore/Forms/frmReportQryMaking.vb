Public Class frmReportQryMaking
    ...
    Private Sub LoadCtrls()
        ...
        Try
            msSql = " show tables like 'Chola%'"
            dtTables = GetDataTable(msSql)
    ...
    Private Sub AddTable()
        Try
            ...
            If lstSelectedTables.Items.Count > 0 Then
                ...
                For i = 0 To lstSelectedTables.Items.Count - 1
                    msSql = " desc " & lstSelectedTables.Items(i).ToString

                    dtFields = GetDataTable(msSql)
    ...
    Private Sub btnCondAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCondAdd.Click
        Try
            ...
            If cboCondField.Text = "" Then
                MsgBox("Please select the Condition field ..", MsgBoxStyle.Information, gProjectName)
                cboCondField.Focus()
                Exit Sub
            End If

            If cboCondition.Text = "" Then
                MsgBox("Please select the Condition ..", MsgBoxStyle.Information, gProjectName)
                cboCondition.Focus()
                Exit Sub
            End If

            If cboCondValue.Text = "" Then
                MsgBox("Please select the Condition Value ..", MsgBoxStyle.Information, gProjectName)
                cboCondValue.Focus()
                Exit Sub
            End If
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        If lstRptSelectedFields.Items.Count > 0 Then
            ...
            objfrm.ShowDialog()
        Else
            MsgBox("Please select the Report Fields.. ", MsgBoxStyle.Information, gProjectName)
            lstRptFields.Focus()
            Exit Sub
        End If
    End Sub
    ...
    Private Sub btnCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        If MsgBox("Are you sure want to Close?", MsgBoxStyle.YesNo, gProjectName) = MsgBoxResult.Yes Then
            Me.Close()
        End If
    End Sub
    ...
    Private Sub lstRptFields_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstRptFields.GotFocus
        If lstSelectedTables.Items.Count > 0 Then
            ...
            Next
        Else
            MsgBox("Please select Tables for Report Fields..", MsgBoxStyle.Information, gProjectName)
            lstTables.Focus()
            Exit Sub
        End If
    End Sub
