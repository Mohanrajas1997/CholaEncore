Public Class frmDelInwardFile
    ...
    Private Sub dtpImportDate_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dtpImpDate.ValueChanged
        ...
        msSQL &= " where import_on >= '" & Format(CDate(dtpImpDate.Value), "yyyy-MM-dd") & "' "
        msSQL &= " and import_on < '" & Format(DateAdd("d", 1, CDate(dtpImpDate.Value)), "yyyy-MM-dd") & "' "

        gpBindCombo(msSQL, "file_name", "file_gid", cboFileName, gOdbcConn)
    End Sub
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Try
            ...
            If MsgBox("Are you sure to delete ?", MsgBoxStyle.YesNo + MsgBoxStyle.Question + MsgBoxStyle.DefaultButton2, gProjectName) = MsgBoxResult.Yes Then
                msSQL = ""
                msSQL &= " select count(*) from chola_trn_tinward as i "
                msSQL &= " where i.inward_file_gid = " & lnFileId & " "
                msSQL &= " and i.inward_packet_gid > 0 "
                ...
                msSQL = "delete from chola_trn_tinward where inward_file_gid = " & lnFileId & " and inward_packet_gid = 0 "
