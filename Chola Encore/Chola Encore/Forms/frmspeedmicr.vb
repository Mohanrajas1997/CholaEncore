    ...
    Private Sub Importexcel(ByVal FilePath As String, ByVal SheetName As String)
        ...
        Try
            ...
            For liIndex As Integer = 0 To lExcelDatatable.Rows.Count - 1
                ...
                'Check for Duplicate
                lssql = " Select micr_gid from chola_mst_tspeedmicr where micr_deleteflag='N' and " & _
                ...
                If Val(lsFileGid) > 0 Then
                    lidup += 1
                    liIsDuplicate += 1
                    lsDuplicatedtl = Now() & " Duplicate exist " & QuoteFilter(lExcelDatatable.Rows(liIndex)("MICR CODE").ToString) & ""
                ...
                Try
                    ...
                    lssql = " Insert into chola_mst_tspeedmicr (micr_fileid,micr_code)"
                    lssql &= " values ("
                    lssql &= lsFileMstGid & ","
