Imports System.IO
Public Class frmhandsoffimport
    ...
    Private Sub Importexcel(ByVal FilePath As String, ByVal SheetName As String)
        ...
        lsFldNmesInfo = "SNo|Agreement No|Repayment Mode|Customer Name|Type|Remarks"
        ...
        Try
            ...
            For liIndex As Integer = 0 To lExcelDatatable.Rows.Count - 1
                ...
                Try
                    ...
                    lssql &= "handsoff_customername,handsoff_type,handsoff_remarks,handsoff_importdate) values ("
                    lssql &= lsFileMstGid & ","
                    ...
                    lssql &= "'" & QuoteFilter(lExcelDatatable.Rows(liIndex)("Remarks").ToString) & "',sysdate())"
