Public Class frmalmaraentry1
    ...
    Private Sub frmalmaraentry_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Enter Then SendKeys.Send("{TAB}")
    End Sub

    Private Sub frmalmaraentry_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        e.KeyChar = e.KeyChar.ToString.ToUpper
    End Sub

    Private Sub frmalmaraentry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            If txtGNSAREfNoTo.Text.Trim <> "" Then
                Sqlstr = ""
                Sqlstr &= " SELECT almaraentry_gid FROM chola_trn_almaraentry"
                Sqlstr &= " WHERE (" & txtGNSAREfNoFrom.Text & " BETWEEN almaraentry_refnofrom AND almaraentry_refnoto"
                Sqlstr &= " OR " & txtGNSAREfNoTo.Text & " BETWEEN almaraentry_refnofrom AND almaraentry_refnoto)"
                If Val(txtId.Text) <> 0 Then
                    Sqlstr &= " AND almaraentry_gid<> " & txtId.Text
                End If
                Sqlstr &= " AND almaraentry_deleteflag ='N'"
    ...
    Private Sub txtDocNoTo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        e.Handled = gfIntEntryOnly(e)
    End Sub

    Private Sub txtDocNoTo_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs)
