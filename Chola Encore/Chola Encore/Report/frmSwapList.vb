Public Class frmSwapList
    ...
    Private Sub btnRefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRefresh.Click
        Try
            ...
            msSql = ""
            msSql &= " select s.shortagreement_no as 'Short Agreement No',a.agreement_no as 'AgreementNo',p.packet_gnsarefno as 'GNSAREF',p.packet_mode as 'Mode',"
            msSql &= " e.almaraentry_cupboardno as 'Cupboard No',e.almaraentry_shelfno as 'Shelf No',e.almaraentry_boxno as 'Box No' "
            ...
            msSql &= " left join chola_trn_tpacket as p on p.packet_agreement_gid = a.agreement_gid "
            msSql &= " and p.packet_status & " & (GCPACKETCHEQUEENTRY Or GCPACKETCHEQUEREENTRY Or GCPACKETVAULTED) & " > 0 "
            msSql &= " and p.packet_status & " & (GCPACKETRETRIEVAL Or GCIPACKETPULLOUT Or GCPKTOLDSWAP) & " = 0 "
