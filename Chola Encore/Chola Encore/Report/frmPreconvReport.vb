    ...
    Private Sub btnRefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRefresh.Click
        Try
            ...
            Select Case cboStatus.Text
                Case "Posted"
                    lsCond &= " and p.finone_entry_gid > 0 "
                Case "Not Posted"
                    lsCond &= " and p.finone_entry_gid = 0 "
                Case "Disc"
            ...
            msSql &= " p.finone_custname as 'Cust Name',"
            msSql &= " p.finone_bankname as 'Bank Name',"
            msSql &= " p.finone_micrcode as 'Micr Code',"
            msSql &= " p.finone_entry_gid as 'Pdc Id',"
            ...
            msSql &= " inner join chola_trn_tfinonepreconverfile as p on p.finone_file_gid = f.file_gid "
